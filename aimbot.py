...
class Aimbot:
    ...
    def __init__(self, box_constant = detection_box_size, collect_data = False, mouse_delay = 0.0007, debug = False):
        ...
        self.model.iou = 0.15 # NMS IoU (0-1)
